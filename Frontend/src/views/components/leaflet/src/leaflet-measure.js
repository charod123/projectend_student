...
! function(e) {
    ...
    t.m = e, t.c = r, t.d = function(e, r, n) { t.o(e, r) || Object.defineProperty(e, r, { configurable: !1, enumerable: !0, get: n }) }, t.n = function(e) { var r = e && e.__esModule ? function() { return e.default } : function() { return e }; return t.d(r, "a", r), r }, t.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, t.p = "/dist/", t(t.s = 28)
        ...
        L.Control.Measure = L.Control.extend({
            ...
            _getMeasurementDisplayStrings: function(e) {
                ...
                function r(e, t, r, n) {
                    var o = { acres: "Acres", feet: "Feet", kilometers: "Kilometers", hectares: "Hectares", meters: "Meters", miles: "Miles", sqfeet: "Sq Feet", sqmeters: "Sq Meters", sqkilometers: "Sq kilometers", sqmiles: "Sq Miles" },
                ...
                var areakm2n = (e.area / 1000000);
                var areakm2 = areakm2n.toLocaleString();
                ...
                return {
                    ...
                    areaDisplayKm: t((e.area / 1000000.00)),
                    areakm2
        ...
        var o = function() {
            ...
            i = { activeColor: "#ABE67E", completedColor: "#087530" },
            s = function() {
    ...
    }, function(e, t, r) { e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="เครื่องมือวัด <br> ระยะทางและขนาดพื้นที่">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>เครื่องมือวัด <br> ขนาดพื้นที่</h3> <ul class=tasks> <a href=# class="js-start start">คลิกเพื่อใช้เครื่องมือวัด</a> </ul> </div> <div class=js-measuringprompt> <h3>เครื่องมือวัด <br> ขนาดพื้นที่</h3> <p class=js-starthelp>เริ่มสร้างการวัดโดยคลิกจุดบนแผนที่ <br/>เมื่อสร้างจุดเสร็จให้คลิกที่ปุ่ม  Finish <br/> เมื่อต้องการยกเลิกให้คลิกที่ปุ่ม Cancel</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancel</a></li> <li><a href=# class="js-finish finish">Finish</a></li> </ul> </div> </div> ' },
    function(e, t, r) { e.exports = '<div class=group> <p class="lastpoint heading" style=" color: #000000"><b>Last point</b></p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading style=" color: #000000" ><b>Path distance</b></span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading style=" color: #000000 "><b>Area</b></span> {{ model.areaDisplay }}</p> </div> <% } %> ' },
    ...
    function(e, t, r) { e.exports = '<h3>วัดระยะทาง</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this line</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ' },
    function(e, t, r) { e.exports = '<h3>วัดขนาดพื้นที่</h3> <b><p>ขนาดพื้นที่</p></b><p>{{ model.areakm2 }} Sq Kilometers</p><p>{{ model.areaDisplay }}</p> <br/><b><p>ความยาวเส้น</p></b><p>{{ model.lengthDisplay }} </p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ' }
]);