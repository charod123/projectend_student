...
// exports.execute = async (script, connectionstring) => {
...
//         console.log(moment().format('YYYY-MM-DD HH:mm:ss.SSS'), "Execute action: " + res.rowCount + " row(s)");
//       }
//       else {
//         console.log(moment().format('YYYY-MM-DD HH:mm:ss.SSS'), "Execute action: 0 row(s)");
//       }
